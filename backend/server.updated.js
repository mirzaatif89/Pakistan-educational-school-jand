...
const UPLOADED_ASSIGNMENTS_FILE = path.join(__dirname, 'uploaded_assignments.json');
const STUDENT_DIARIES_FILE = path.join(__dirname, 'student_diaries.json');
const STUDENT_ASSIGNMENT_SUBMISSIONS_FILE = path.join(__dirname, 'student_assignment_submissions.json');
